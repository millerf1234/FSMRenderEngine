/*
    OpenGL loader generated by glad 0.1.28 on Wed Jan  9 00:23:07 2019.
    ...
    Commandline:
        --profile="core" --api="gl=4.6" --generator="c-debug" --spec="gl" --local-files --extensions="GL_EXT_convolution,GL_EXT_framebuffer_blit,GL_EXT_framebuffer_multisample,GL_EXT_framebuffer_multisample_blit_scaled,GL_EXT_framebuffer_object,GL_EXT_framebuffer_sRGB,GL_EXT_multisample,GL_EXT_polygon_offset,GL_EXT_provoking_vertex,GL_EXT_shadow_funcs,GL_EXT_texture,GL_EXT_texture_buffer_object,GL_EXT_texture_compression_latc,GL_EXT_texture_compression_rgtc,GL_EXT_texture_compression_s3tc,GL_EXT_texture_cube_map,GL_EXT_texture_filter_anisotropic,GL_EXT_texture_object,GL_EXT_texture_sRGB,GL_EXT_texture_swizzle"
    Online:
...
///////////////////////////////////////////////////////////////
////    IMPORTANT NOTE:   MODIFICATION MADE TO CODE!
////                           
...
////        post-callback functions which themselves call the OpenGL function glGetError, which expands
////        to the macro that calls itself. I could be wrong about this though because everything seems
////        to work fine anyways. 
////        Anyways, I am adding a modification to this file's code to just ignore the first error
////        reported after OpenGL is first loaded. 
////
/////////////////////////////////////////////////////////////////
...
int gladLoadGLLoader(GLADloadproc load) {
	...
	/////////I am modifing the file by adding the following line which will clear the error state
	glGetError();
