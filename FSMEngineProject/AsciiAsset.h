...
namespace AssetLoadingInternal {
    ...
    public:
        ...
        */
        ...
        //Returns the number of lines that begin with the specified character. Any Spaces (' ') and/or tabs
    ...
    private:        //Fields
        ...
        typedef struct NewLineLocation { //The start of a non-empty filetext string will be considered 
            ...
            int lineLength;
            //Constructor
            NewLineLocation(int number, int offset, int lineLength = 0) : lineNumber(number), offset(offset), lineLength(lineLength) { ; }
        } NewLineLocation;
