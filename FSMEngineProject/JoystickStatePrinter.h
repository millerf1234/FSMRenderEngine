...
//                           came into existence as one of Microsoft's many DirectX libraries.
...
public:
	...
	//fixing a Joystick that wasn't in default state when it was first initialized.
...
private:
	...
	typedef struct JoystickStateAtConnection {
		...
		std::vector<int> axesPredictedToBeTriggers; //Vector of the index of each axis suspected of being a trigger
	} BaseJoyState;
