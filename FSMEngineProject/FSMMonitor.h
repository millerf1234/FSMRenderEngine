...
// Date:         Mid-to-Late December 2018 [Work started] ---> Early Jan 2019 [Completion]
// 
// Modifications: Starting on March 7, 2019  converted from having interface and 
//                implementation interspersed to using pointer to seperate implementation
//                from interface.
